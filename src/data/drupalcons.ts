...
export const drupalcons: DrupalCon[] = [
  ...
  { year: 2026, city: "Chicago",               talk: "Fireside with Tim Lehnen (Summit, unrecorded) · Agentic interfaces (Summit breakout, unrecorded) · MCP live demo (youtube)", url: "https://youtu.be/MkmSpV2l_1k", rec: "youtube", featured: true },
];
